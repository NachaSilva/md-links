...
**--stats --validate**
**--help**
Estos se explican en el punto 4.


## 4. Ejemplos de uso

* Visualizar el archivo markdown a partir de la ruta que recibe como argumento y analiza el archivo Markdown e imprime los links que vaya encontrando, junto con la ruta del archivo donde aparece y el texto que hay dentro del link.
